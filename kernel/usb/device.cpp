...
namespace usb {
    ...
    Error Device::OnControlCompleted(EndpointID ep_id, SetupData setup_data,
        ...
        Log(LogLevel::Debug, "Device::OnControlCompleted: buf 0x%08x, len %d, dir %d\n",
        ...
        if (is_initialized_) {
            ...
            return MAKE_ERROR(ErrorCode::NoWaiter);
        }
    ...
    Error Device::InitializePhase2(const uint8_t* buf, int len) {
        ...
        if (conf_desc == nullptr) {
            return MAKE_ERROR(ErrorCode::InvalidDescriptor);
        }
        ...
        initialize_phase_ = 3;
        Log(LogLevel::Debug, "issuing SetConfiguration: conf_val=%d\n",
